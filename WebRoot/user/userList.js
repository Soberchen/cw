layui.extend({
    ...
    var tableIns = table.render({
        elem: '#newsList',
        url : 'SelectUserServlet?action=selectUser',
        toolbar: '#toolbarDemo',
        page : false,//开启分页
        height: 'full-145',
        ...
        cols : [[
            ...
            {field: 'roleName', title: '管理角色', minWidth:100, align:"center",sort:true},
            {field: 'partName', title: '职称', minWidth:100, align:"center",sort:true},
            {field: 'workName', title: '所在部门', minWidth:100, align:"center",sort:true},
    ...
    $("#doSubmit").click(function(){
    	var like = $("#likename").val()
    	 ...
    	 tableIns.reload({
	      url:"http://localhost:8080/ControlText/SelectUserServlet?action=selectUser&uname="+like,
	      page: {
	        curr: 1 //重新从第 1 页开始
	      }
	    });
