...
<form class="layui-form layui-form-pane" action="Javascript:void(0)">
  ...
  <div class="layui-form-item">
    <button class="layui-btn layui-btn-fluid" id="xiugai" lay-filter="upStudent">修改用户</button>
  </div>
</form>
...
<script type="text/javascript" src="<%=basePath %>admin/pagejs/system/student/stuInfo.js"></script>
</body>
</html>